...
public class NewTaskDialog extends DialogFragment {
    ...
    public static NewTaskDialog newInstance(QuadrantFragment fragment) {
        NewTaskDialog newTaskDialog = new NewTaskDialog();
        newTaskDialog.fragment = fragment;
                ...
                .setPositiveButton("save",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int id) {
                                fragment.NewTaskDialogCallback(mTitle.getText().toString().trim());
                                getDialog().dismiss();
                            }
                        })
